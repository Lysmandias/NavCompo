...
public class SecondFrag extends Fragment {
    ...
    public void onViewCreated(@Nullable View view, @Nullable Bundle savedIntanceState) {
        ...
        View.OnClickListener secondTofirst = Navigation.createNavigateOnClickListener(R.id.action_secondFrag_to_firstFrag);
        ConstraintLayout cl2 = view.findViewById(R.id.secondFrag);
        cl2.setOnClickListener(secondTofirst);
    }
}